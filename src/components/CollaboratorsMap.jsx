...
const collaboratorsByCountry = {
  colombia: [
    { name: "Ivan David Lozada-Martinez", role: "CEO y Fundador", institution: "Centro de Consultoría Científica y Meta-Investigación en Ciencias Biomédicas (CECIMIB)", orcid: "https://orcid.org/0000-0002-1960-7334" },
    { name: "Andy A. Acosta-Monterrosa", role: "Asistente de Investigación", institution: "Centro de Consultoría Científica y Meta-Investigación en Ciencias Biomédicas (CECIMIB)", orcid: "https://orcid.org/0000-0002-6860-1043" },
    { name: "David A. Hernandez-Paez", role: "Asistente de Investigación", institution: "Centro de Consultoría Científica y Meta-Investigación en Ciencias Biomédicas (CECIMIB)", orcid: "https://orcid.org/0000-0002-6742-3185" },
          ...
          <div className="cards-slider-wrapper">
            ...
            <div className="cards-scroll-container" id="cards-scroll-container">
              {collaboratorsByCountry[activeCountry].map((collab, index) => {
                ...
                if (collab.role === 'CEO y Fundador') roleKey = 'ceo_fundador';
                if (collab.role === 'Asistente de Investigación') roleKey = 'asistente_investigacion';
